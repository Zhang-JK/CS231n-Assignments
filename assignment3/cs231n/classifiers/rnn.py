...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            h, cache_h = rnn_forward(word_embed, h0, Wx, Wh, b)
        elif self.cell_type == 'lstm':
            h, cache_h = lstm_forward(word_embed, h0, Wx, Wh, b)
        ...
        dh0 = None
        if self.cell_type == 'rnn':
            dword_embed, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dh, cache_h)
        elif self.cell_type == 'lstm':
            dword_embed, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dh, cache_h)
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
            word_embed, _ = word_embedding_forward(word, W_embed)       # what a surprise it also works with 1D array
            if self.cell_type == 'rnn':
